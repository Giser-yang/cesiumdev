...
class NormalPrimitive extends Cesium.Primitive {
    constructor(options) {
        super(options);
    ...
    createCommand = (fragmeState, modelMatrix) => {
        ...
        for (let index = 0; index < this.features.length; index++) {
            ...
            sequence = this.setData(element, lowPositionArray, highPositionArray, indexArray, uvs, normals, colors,pickId.color,batchIds, sequence)
            if (index == this.features.length - 1) {
                ...
                const batchIdsTypedArray = new Float32Array(batchIds);
                ...
                attributes.push(this.addAttributes(3, this.createVertexBuffer(context, normalTypedArray), 3, normalTypedArray))
                attributes.push(this.addAttributes(4, this.createVertexBuffer(context, colorsTypedArray), 3, colorsTypedArray))
                attributes.push(this.addAttributes(5, this.createVertexBuffer(context, batchIdsTypedArray), 1, batchIdsTypedArray))
    ...
    setData(element, lowPositionArray, highPositionArray, indexArray, uvs, normals, colors,color,batchIds, sequence) {
        const coordinates = element.geometry.coordinates[0];
        const properties = element.properties;
        const id = properties.FID
        const points = []
        ...
        for (let index = 1; index < coordinates.length; index++) {
            ...
            this.getCartesian3(pointBot, lowPositionArray, highPositionArray, colors,color,batchIds,id);
            this.getCartesian3(nextPointBot, lowPositionArray, highPositionArray, colors,color,batchIds,id);
            this.getCartesian3(nextPointTop, lowPositionArray, highPositionArray, colors,color,batchIds,id);
            this.getCartesian3(nextPointTop, lowPositionArray, highPositionArray, colors,color,batchIds,id);
            this.getCartesian3(pointTop, lowPositionArray, highPositionArray, colors,color,batchIds,id);
            this.getCartesian3(pointBot, lowPositionArray, highPositionArray, colors,color,batchIds,id);
            if (index == 1) {
            ...
            if (index == coordinates.length - 1) {
                ...
                for (let j = 0; j < triangles.length;) {
                    ...
                    this.getCartesian3(point1, lowPositionArray, highPositionArray, colors,color,batchIds,id);
                    this.getCartesian3(point2, lowPositionArray, highPositionArray, colors,color,batchIds,id);
                    this.getCartesian3(point3, lowPositionArray, highPositionArray, colors,color,batchIds,id);
    ...
    getCartesian3(points, lowArray, highArray, colors,color,batchIds,id) {
